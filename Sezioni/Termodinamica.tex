        ...
        \subsubsection{Le variabili principali}
          ...
          Analizziamole velocemente:
            ...
            \subsubsection{Equazione di stato dei gas ideali (o perfetti)}
                ...
                Questa equazione la si ottiene basandosi sui risultati di 3 (o meglio 4) leggi:
                \begin{itemize}
                    \item \textbf{Legge isocora di Gay-Lussac}: se noi teniamo il \textbf{volume costante} ($V=const$, isocora), abbiamo che pressione la corrisponde a:
                        \begin{align*}
                            p=p_0(1+\beta t)
                        \end{align*}
                    ...
                    \item \textbf{Legge isobara di Gay-Lussac}: se noi teniamo la \textbf{pressione costante} ($p=const$, isobara), abbiamo che il volume in funzione della temperatura corrisponde a:
                        \begin{align*}
                            V=V_0(1+\alpha t)
                        \end{align*}
                        Se noi rappresentassimo questa equazione sul piano cartesiano in funzione della temperatura, otterremo qualcosa del genere:
                    ...
                    \item \textbf{Legge isoterma di Boyle}: a parità di temperatura, il \textbf{prodotto $p*V$ resta costante}! Ovvero:
                    \begin{align*}
                    ...
                    \item \textbf{Legge di Avogadro}: gas diversi nelle stesse condizioni di temperatura, pressione e volume, \textbf{contengono lo stesso numero di elementi} ($N$). In particolare, abbiamo che:
                    \begin{align*}
