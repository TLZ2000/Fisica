\section{Dinamica}
    ...
    \subsection{Esercizio sulla dinamica}
        ...
        \begin{itemize}
            ...
            \item la \textbf{forza elastica} $\vec{F}_{el}=-k*(\vec{z}-\vec{z}_0)$. La parte tra parentesi viene chiamata "\textbf{forza di richiamo}" e \textbf{dipende dal sistema di riferimento che adottiamo} (in particolare la $z_0$, che indica la \textbf{posizione di riposo} della nostra molla).
        \end{itemize}
