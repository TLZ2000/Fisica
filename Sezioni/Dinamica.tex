\section{Dinamica}
    \subsection{Leggi della dinamica}
        ...
        \begin{enumerate}
            ...
            Nel caso in cui la massa non varia, allora la forza può essere definita come $\vec{F}=m\cdot\vec{a}$. Questo perché $dm = 0$ (la massa non cambia) e $\frac{d\vec{v}}{dt} \triangleq \vec{a}$\\
